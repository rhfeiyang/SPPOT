...
from models.classifer import Cos_classifier, ETF_Classifier
...
class ClusteringModel(nn.Module):
    def __init__(self, backbone, nclusters, nheads=1, head_type="linear"):
        ...
        if head_type=="linear":
            ...
            self.cluster_head = nn.ModuleList([ETF_Classifier(self.backbone_dim, nclusters[i]) for i in range(self.nheads)])
